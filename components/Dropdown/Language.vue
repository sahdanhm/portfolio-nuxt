...
<template>
  <button
    ...
    class="inline-flex justify-center text-xs text-gray-900 cursor-pointer"
  >
    <svg
      class="h-5 w-5 me-2"
    ...
    <span class="self-end">English (US)</span>
  </button>
  <!-- Dropdown -->
  <div
    :class="{ hidden: !isDropdownOpen }"
    class="z-50 absolute my-6 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm"
